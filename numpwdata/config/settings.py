"""
Django settings for numpwdata project.
...
ROOT_URLCONF = "numpwdata.config.urls"
...
WSGI_APPLICATION = "numpwdata.config.wsgi.application"
...
MIGRATION_MODULES = {"notifications": "numpwdata.config.migrations.notifications"}
