    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('misc', models.JSONField(help_text='Miscellaneous information about the interaction.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qval', models.DecimalField(decimal_places=4, help_text='Value of momentum transfer in inverse fermi.', max_digits=8)),
                ('thetaval', models.DecimalField(decimal_places=4, help_text='?', max_digits=8)),
                ('momentum_info', models.JSONField(help_text='Momentum mesh used for density representing the matrix.')),
                ('channel_info', models.JSONField(help_text='Information about quantum channels.')),
                ('mesh_info', models.JSONField(help_text='Internal mesh information used to obtain the density')),
                ('file', models.ForeignKey(help_text='File information about density.', on_delete=django.db.models.deletion.CASCADE, to='files.h5file', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('momentum_info', models.JSONField(help_text='Momentum mesh used for density representing the matrix.')),
                ('channel_info', models.JSONField(help_text='Information about quantum channels.')),
                ('mesh_info', models.JSONField(help_text='Internal mesh information used to obtain the density, e.g., in integrations.')),
                ('file', models.ForeignKey(help_text='File information about density.', on_delete=django.db.models.deletion.CASCADE, to='files.datfile', unique=True)),
                ('interaction', models.ForeignKey(help_text='Interaction used to compute nucleus.', on_delete=django.db.models.deletion.CASCADE, to='densities.interaction')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('interaction_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='densities.interaction')),
                ('name', models.CharField(help_text='Name of the interaction.', max_length=200, unique=True)),
