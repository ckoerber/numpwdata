"""Prepares the usage of the numpwdata module
"""
import os
...
def _init():
    """Initializes the django environment for numpwdata
    """
    os.environ.setdefault("DJANGO_SETTINGS_MODULE", "numpwdata.config.settings")
    _setup()
